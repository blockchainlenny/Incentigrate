...
import ForumScreen from "@/app/components/ForumScreen";
import LearningModulesList from "@/app/components/LearningModulesList";
import SingleModuleView from "@/app/components/SingleModuleView";
import WalletScreen from "@/app/components/WalletScreen";
import IntegrationJourneyScreen from "@/app/components/IntegrationJourneyScreen";
import { useState, useEffect } from "react";
import { LayoutDashboard, BookOpen, MessagesSquare, Wallet as WalletIcon, MapIcon } from 'lucide-react';
...
export default function Home() {
  ...
  useEffect(() => {
    if (
      ...
      currentView !== 'integration_journey'
    ) {
      // Allow dashboard/wallet/integration_journey to show their own login prompts
    }
  ...
  const navItems: NavItem[] = [
    ...
    { view: 'integration_journey', label: 'My Path', icon: MapIcon },
